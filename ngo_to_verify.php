...
<?php
$query=mysqli_query($conn,"select * FROM ngo where flag='0'") or die(mysqli_error($conn));
...
<tr>
    ...
    <td><a href="verify_ngo.php?id=<?php echo $row['ngoId'];?>" class="btn btn-danger">Verify</a></td>
