...
<?php
$query=mysqli_query($conn,"select * FROM volunteer where flag='1'") or die(mysqli_error($conn));
...
<tr>
    ...
    <td><a href="delete.php?vid=<?php echo $row['ID'];?>" class="btn btn-danger">Delete</a></td>  
