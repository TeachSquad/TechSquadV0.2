...
<?php
$query=mysqli_query($conn,"select * FROM donation") or die(mysqli_error($conn));
...
<tr>
    ...
    <td><?php echo $row['date_of_pickup'];?></td>
    <td><?php echo $row['time_of_pickup'];?></td>
    <td><?php echo $row['item'];?></td> 
    <td><?php echo $row['quantity'];?></td>
    <td><a href="delete.php?did=<?php echo $row['donationId'];?>" class="btn btn-danger">Delete</a></td>
    <td><a href="moreDetails.php?did=<?php echo $row['donationId'];?>" class="btn btn-danger">Details</a></td>  
