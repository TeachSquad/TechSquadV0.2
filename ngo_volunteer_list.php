...
<?php
$query=mysqli_query($conn,"select * FROM volunteer where flag='1' and registered_with_ngo='$ngoId' ") or die(mysqli_error($conn));
...
<tr>
    ...
    <!-- <td><a href="delete_ngo_volunteer.php?vid=<?php echo $row['ID']."=".$row1['ngo_name'];?>" class="btn btn-danger">Delete</a></td>   -->
